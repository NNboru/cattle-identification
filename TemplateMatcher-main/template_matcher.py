...
if __name__ == "__main__":
    ...
    #temp_img_gray = cv2.cvtColor(temp_img_gray1, cv2.COLOR_BGR2GRAY)
    #map_img_gray = cv2.cvtColor(map_img_gray1, cv2.COLOR_BGR2GRAY)
    
    #temp_img_gray = cv2.normalize(temp_img_gray, None, 0, 255, cv2.NORM_MINMAX).astype('uint8')
    #map_img_gray = cv2.normalize(map_img_gray, None, 0, 255, cv2.NORM_MINMAX).astype('uint8')
